    ...
    if (token != null) {
      ...
      for (const score of scores) {
        ...
        if (trueToken == null) {
          ...
          trueToken = { TOKEN: await renewOsuToken({REFRESH_TOKEN:trueToken["REFRESH_TOKEN"]}) }; // can't test if it works, hopefully it does
        }
